...
<html>
<head>
<title>Actualizeaza telefon</title>
<meta charset="utf-8">
			...
			<form action="./UpdateProductSrv" method="post"
				...
				<div style="font-weight: bold;" class="text-center">
					<div class="form-group">
						...
						<h2 style="color: green;">Actualizeaza telefon</h2>
					</div>
				...
				<div class="row">
					<div class="col-md-6 form-group">
						<label for="last_name">Nume</label> <input type="text"
					...
					<div class="col-md-6 form-group">
						...
						%>
						<label for="producttype">Categorie</label> <select name="type"
							id="producttype" class="form-control" required>
							<option value="mobile"
								<%="mobile".equalsIgnoreCase(ptype) ? "selected" : ""%>>Telefon Nou</option>
							<option value="tv"
								<%="tv".equalsIgnoreCase(ptype) ? "selected" : ""%>>Telefon SH</option>
						</select>
					</div>
				</div>
				<div class="form-group">
					<label for="last_name">Descriere</label>
					<textarea name="info" class="form-control text-align-left"
						id="last_name" required><%=product.getProdInfo()%></textarea>
				</div>
				<div class="row">
					<div class="col-md-6 form-group">
						<label for="last_name">Pret</label> <input type="number"
							value="<%=product.getProdPrice()%>"
							placeholder="Enter Unit Price" name="price" class="form-control"
							id="last_name" required>
					</div>
					<div class="col-md-6 form-group">
						<label for="last_name">Cantitate</label> <input type="number"
				...
				<div class="row text-center">
					...
					<div class="col-md-4">
						<button type="submit" class="btn btn-success">Actualizeaza
							telefon</button>
					</div>
				</div>
			</form>
