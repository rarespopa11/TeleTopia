...
<body style="background-color: #E6F9E6;">
	...
	<div class="text-center"
		style="color: green; font-size: 24px; font-weight: bold;">Detalii
		Cos</div>
		...
		<table class="table table-hover">
			...
			<tbody
				...
				<tr style="background-color: grey; color: white;">
					<td colspan="6" style="text-align: center;">Pretul
						total</td>
					<td><%=totAmount%></td>
				</tr>
				<%
				...
				<tr style="background-color: grey; color: white;">
					...
					<td><form method="post">
							<button formaction="userHome.jsp"
								style="background-color: black; color: white;">Anuleaza</button>
						</form></td>
					<td colspan="2" align="center"><form method="post">
							<button style="background-color: blue; color: white;"
								formaction="payment.jsp?amount=<%=totAmount%>">Plateste</button>
						</form></td>
