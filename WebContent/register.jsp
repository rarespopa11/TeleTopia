			...
			<form action="./RegisterSrv" method="post"
				...
				<div class="row">
					<div class="col-md-6 form-group">
						<label for="first_name">Nume</label> <input type="text"
				...
				<div class="row">
					<div class="col-md-6 form-group">
						<label for="last_name">Numar de telefon</label> <input type="number"
							name="mobile" class="form-control" id="last_name"
							name="last_name" required>
					</div>
					<div class="col-md-6 form-group">
						<label for="last_name">Cod postal</label> <input type="number"
				...
				<div class="row">
					<div class="col-md-6 form-group">
						<label for="last_name">Parola</label> <input type="password"
							name="password" class="form-control" id="last_name"
							name="last_name" required>
					</div>
					<div class="col-md-6 form-group">
						<label for="last_name">Confirma parola</label> <input
